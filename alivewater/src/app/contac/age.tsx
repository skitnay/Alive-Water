				...
				<div className={classes.contacts__contact}>
					...
					<div className={classes.contacts__social}>
						<div className={classes.contacts__vk}>
							<Link href="https://vk.com/alivewaternsk" target="_blank">
								<a>
									<Image
										loader={myLoader}
										src="/icons/vk.webp"
						...
						<div className={classes.contacts__2gis}>
							<Link
								href="https://2gis.ru/novosibirsk/branches/70000001094429194?m=82.850647%2C54.817341%2F16"
								target="_blank"
							>
								<a>
									<Image
