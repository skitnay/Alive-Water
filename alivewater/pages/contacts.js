				...
				<div className={classes.contacts__contact}>
					...
					<div className={classes.contacts__social}>
						<div className={classes.contacts__vk}>
							<Link href="https://vk.com/alivewaternsk"><a target="_blank"><ExportedImage src='/vk.png' width={45} height={45} /></a></Link>
						</div>
						<div className={classes.contacts__od}>
							<Link href="https://ok.ru/profile/580408735701"><a target="_blank"><ExportedImage src='/od.png' width={45} height={45} /></a></Link>
						</div>
						<div className={classes.contacts__wa}>
							<Link href="https://wa.me/79134531010"><a target="_blank"><ExportedImage src='/wa.png' width={45} height={45} /></a></Link>
						</div>
						<div className={classes.contacts__2gis}>
							<Link href="https://2gis.ru/novosibirsk/branches/70000001038983235?m=83.064884%2C55.055966%2F9.68"><a target="_blank"><ExportedImage src='/2gis.png' width={100} height={45} /></a></Link>
						</div>
					</div>
				</div>
				<div className={classes.contacts__contact}>
